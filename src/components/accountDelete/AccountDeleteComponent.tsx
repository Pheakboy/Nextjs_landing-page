...
export default function AccountDeleteComponent() {
  ...
  return (
    <div className='p-6 w-full'>
        <h2 className='text-2xl font-semibold text-gray-900 mb-4'>Manage your account</h2>
        ...
        <p className='font-semibold text-gray-800'>Enter your phone number to confirm deletion.</p>
        ...
        <button className='mt-6 bg-red-600 text-white font-semibold py-2 px-4 rounded-md hover:bg-red-700' onClick={handleDeleteAccount}>
          Delete My Account
        </button>
      </div>
  )
