  ...
  return (
    <div className='max-w-3xl mx-auto py-5 text-gray-700'>
      ...
      <section className='pb-2'>
        <h2 className='text-[#000000] text-lg font-semibold py-8'>
          1. INTRODUCTION AND OUR RULES
        </h2>
        <p className='text-[#000000] text-base pb-4 font-medium'>
      ...
      <section className='pb-2'>
        ...
        <p className='text-[#000000] text-base pb-4 font-medium'>
          ...
          collect and pay any relevant taxes on be-half of the participating
          restaurants. 
        </p>
        <p className='text-[#000000] text-base pb-4 font-medium'>
      ...
      <footer className='w-full py-8 text-center'>
        ...
        <div className='flex justify-center space-x-4 pt-6'>
          <Link href='/privacy'>
            <p className='underline cursor-pointer mx-2 font-medium'>Terms & Privacy</p>
          </Link>
          <Link href='/privacy'>
